...
module.exports = {
    ...
    execute: async (bot, msg, args) => {
        ...
        let loadingMsg;
        try {
            loadingMsg = await bot.sendMessage(chatId, "🤗 𝐃𝐀𝐑𝐀 𝐁𝐎𝐒 𝐒𝐈𝐘𝐀𝐌 🪬 𝐊𝐄 𝐉𝐈𝐆𝐘𝐀𝐒𝐀 𝐊𝐎𝐑𝐄 𝐀𝐒𝐈 😴🙈", {
        ...
        try {
            ...
            const successText = "🫣 𝐇𝐀𝐓 𝐌𝐀𝐑𝐁𝐈 𝐍𝐀 🤭 𝐊𝐈𝐍𝐓𝐔 𝐏𝐀𝐏𝐈𝐑 𝐃𝐎𝐋 😂\n👑 𝐎𝐖𝐍𝗘𝗥: 𝐒𝐈𝐘𝐀𝐌-𝐇𝐀𝐒𝐀🇳";
            ...
            return bot.sendMessage(chatId, "× ভিডিও আনতে সমস্যা হয়েছে!", {
                reply_to_message_id: messageId
            });
        }
    },
